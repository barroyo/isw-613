...
<head>
    <meta charset="UTF-8">
    <title>Welcome to CodeIgniter 4! - <?php echo $title ?></title>
                    ...
                    <?php
                      foreach ($students as $student) { ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary" href="<?php echo base_url(['student','edit',$student['id']]);?>">Edit</a>
                            <a class="btn btn-danger" href="<?php echo base_url(['student','delete',$student['id']]);?>">Delete</a>
                          </td>
                        </tr>
                    <?php } ?>
                  </tbody>
